...
public class AgentController : Controller
{
    ...
    public async Task<IActionResult> Details(int id)
    {
        ...
        var viewModel = new AgentDetailsViewModel
        {
            ...
            Email = agent.Email,
            PhoneNumber = agent.PhoneNumber,
            Image = agent.ImageUrl ?? string.Empty,
    ...
    public async Task<IActionResult> Message(int agentid)
    {
        var Messages = await _propertyRepository.GetPropertyRequestsAsync(agentid);
